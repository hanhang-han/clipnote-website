    ...
    <section className="relative flex flex-col items-center justify-center min-h-screen text-center px-4 pt-20 overflow-hidden">
      ...
      >
        ...
        >
          ...
          <span className="text-xs text-gray-400 font-medium">Clipboard Active</span>
        </motion.div>

        <h1 className="text-5xl md:text-7xl font-bold bg-gradient-to-r from-blue-400 via-indigo-400 to-purple-400 bg-clip-text text-transparent mb-4">
          灵剪
        </h1>
        <p className="text-lg md:text-xl text-gray-400 mb-2">ClipNote</p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 items-center justify-center">
          ...
          >
            <AppWindow size={20} /> App Store 即将上线
          </motion.a>
        </div>
      </motion.div>
