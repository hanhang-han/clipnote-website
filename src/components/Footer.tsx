...
export default function Footer() {
  ...
  return (
    <footer className="py-12 text-center border-t border-[#222]">
      <p className="text-[13px] text-[#888] font-normal mb-2">© 2026 灵剪 (CliperX)</p>
      <div className="flex justify-center gap-6">
        <a href="mailto:hanhang789@gmail.com" className="text-[13px] text-[#aaa] font-normal no-underline hover:text-white transition-colors">
